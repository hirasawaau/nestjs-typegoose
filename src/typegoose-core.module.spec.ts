...
describe('TypegooseCoreModule', () => {
  describe('forRoot', () => {
    it('should return module that provides a mongoose connection', async () => {
      const connection = {
        asPromise: jest.fn(function () {
      ...
      await expect(dbProvider.useFactory()).resolves.toBe(connection)
    })

    it('should create connection with no mongoose config', async () => {
      const connection = {
        asPromise: jest.fn(function () {
          return Promise.resolve(this)
        }),
      ...
      await (module.exports[0] as FactoryProvider).useFactory()
  ...
  describe('forAsyncRoot', () => {
    ...
    describe('Connection Name', () => {
      ...
      it('creates the mongoose connection', async () => {
        ...
        await expect(
          DbConnectionToken.useFactory(optionsFromOptionFactory),
